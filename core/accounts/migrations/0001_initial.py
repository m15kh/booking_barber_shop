    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=11, null=True, validators=[django.core.validators.RegexValidator('^\\d{11}$', 'Enter a valid 11-digit phone number.')])),
                ('date', models.DateField(blank=True, null=True)),
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('CUSTOMERUSER', 'CustomerUser'), ('BARBERUSER', 'BarberUser')], max_length=50)),
